...
import { topAnimated } from "@/app/components/Collaborate/Collaborate";
...
const Projects = () => {
  return (
    ...
    >
      ...
      <div className="mt-[70px] grid gap-y-12  mx-auto">
        {projectsData.map((project) => {
          return (
            <motion.div
              variants={blocksAnimated}
              key={project.id}
              className="flex lg:grid flex-col-reverse lg:flex-col grid-cols-1 lg:grid-cols-[516px_minmax(516px,_516px)] mx-auto gap-x-12 gap-y-4"
            >
              <div
